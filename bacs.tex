...
\nadpis{Challenges to Professional Football\\Companies and their Answers with Particular\\Regard to Organisational Changes}

\autor{Éva Bába Ms Bács\pozn{University of Debrecen, Faculty of Applied Economics and Rural Development, Böszörményi u.\;138, H-4032 Debrecen, Hungary. E-mail: babae@agr.unideb.hu.}}
\linka{2ex}
...
\popist{Table 1: German football championship revenues in the 2009/2010 season (Bundesliga 1), in billions of euro and \%}
\tabcolsep39pt\small\zactab{|@{\hskip 6pt}lcc|}\hline
Game and  ticket revenues 	&	0.379	&	21.43\%		\\
Sponsorships and advertising 	&	0.512	&	28.92\%		\\
Media revenues 			&	0.505	&	28.55\%	\\
Transfer revenues 			&	0.106 	&	\06.01\%	\\
Merchandising revenues		&	0.074	&	4.7\%	\\
Other revenues				&	0.193	&	10.93\% \\\hline
\bf Total                                    &\bf	1,769	&\bf	100\% \\\hline
\kontab
\zdrojt{Source: 4. Bundesligareport 2011, www.bundesliga.de}

\oddil{Legal field and international balance sheets}
...
\zacseznam
\item[a)] The decision of the Football Association makes the outsourcing of the licence department and its transformation into a~company possible (e.g. Germany) 
\item[b)] The Football Association makes the formation of a~capital company a requirement in level one or in both top levels.
\konseznam
...
\oddil{Environment}
At modern and successful professional football teams, the number of stakeholders increases significantly and harmonising their various needs is a very high level management task.\\[2mm]

\podnadpis{Organizational adaptation of football enterprises}
...
\oddil{Role and significance of legal forms and organizations of enterprises in football}
...
\popist{Figure 2: Distribution of legal status in Germany (I--II. League clubs)}
\tabcolsep20pt\small\zactab{|@{\hskip6pt}lc|}\hline
\bf Legal Form 		&	\bf Frequency\\\hline
Association 		&	15\\
Share comp. 		&	\02\\
LLC 			&	\04\\
LLC with right 		&	\05\\
LLC \& Co.LP. 	&	10\\\hline
I.--II Liga , \bf{Total} 	&	\bf 36\\\hline
\kontab\\

%\clearpage\newpage

\obr{bacs-fig02.jpg}{.8\textwidth}
%\raisebox{.4ex}{\obr{bacs-fig02-label01.jpg}{.7ex}}~Association~~~\obr{bacs-fig02-label02.jpg}{.7ex}~~Share comp.
\zdroj{Source: Dworak, 2010}

\oddil{Advantages and disadvantages of registered association}
...
\vspace*{-2mm}
\begin{longtable}[l]{@{\hskip7mm}l}
\fntit{German championship:}\\[.5mm]
\bull Winners (5): 1950, 1952, \fntit{1984}, \fntit{1992}, \fntit{2007}\\
\bull Runners-up (4): 1935, 1953, \fntit{1979}, \fntit{2003}\\[1mm]
\fntit{German Cup:}\\[.5mm]
\bull Winners (3): \fntit{1954}, \fntit{1958}, \fntit{1997}\\
\bull Runners-up (2): \fntit{1986}, \fntit{2007}\\[1mm]
\fntit{German Super Cup:}\\[.5mm]
\bull Winners (1): 1992\\[1mm]
\fntit{German League Cup:}\\[.5mm]
\bull Runners-up (3): 1997, 1998, 2005\\[1mm]
\fntit{Oberliga Süd I:}\\[.5mm]
\bull Winners (3): 1945--46, 1951--52, 1953--54\\
\bull Runners-up (3): 1949--50, 1952--53, 1955--56\\[1mm]
\fntit{2nd Bundesliga Süd II:}\\[.5mm]
\bull Winners (1): 1977\\[1mm]
\fntit{Bezirksliga Württemberg-Baden:}\\[.5mm]
\bull Winners (2): 1926--27, 1929--30\\
\bull Runners-up (1): 1925--26\\[1mm]
\fntit{Gauliga Württemberg:}\\[.5mm]
\bull Winners (4): 1934--35, 1936--37, 1937--38, 1942--43\\
\bull Runners-up (4): 1938--39, 1939--40, 1940--41, 1941--42\\[1mm]
\fntit{UEFA Cup:}\\[.5mm]
\bull Runners-up (1): \fntit{1988--89}\\[1mm]
\fntit{UEFA Cup Winners' Cup:}\\[.5mm]
\bull Runners-up (1): \fntit{1997--98}\\[1mm]
\fntit{UEFA Intertoto Cup:}\\[.5mm]
\bull Winners (2): \fntit{2000}, \fntit{2002}\\
\end{longtable}

\oddil{Incorporated firms}
...
\popist{Figure 3: Ownership structure}
\obr{bacs-fig03-no-label.jpg}{.8\textwidth}

{\small
\hskip2mm\raisebox{.4ex}{\obr{bacs-fig03-label01-15px.jpg}{.7ex}}~~FC Bayern München e.\;V.\hskip9mm \raisebox{.4ex}{\obr{bacs-fig03-label02-15px.jpg}{.7ex}}~~Audi AG\hskip8mm \raisebox{.4ex}{\obr{bacs-fig03-label03-15px}{.7ex}}~~Adidas AG}
\zdrojt{Source: FC Bayern München website}\\[-2mm]
...
%\zactab{@{\hskip 5mm}p{\textwidth}}
\zacseznam
\item Most Bundesliga titles won: 21
\item Most \fntit{Bundesliga} games won (907) and points achieved (3095)
\item Most game days on top of the league: 592
\item Most average points per game in the Bundesliga: 1.93
\item Most Bundesliga goals scored: 3412
\item Most consecutive wins in the Bundesliga (19 March--20 September, 2005): 15
\item Most games won in a~club's first Bundesliga season (\fntit{1965--66}): 20
\item Biggest lead over second-place finisher (\fntit{2002--03}): 16 points
\item Championship with fewest points under the 3-point rule (\fntit{2000--01}): 63
\item Championship with the most losses in a~season (\fntit{2000--01}): 9
\item As a~negative record, Bayern's match in Dortmund in the \fntit{2000--01 season} was the most unfair match in Bundesliga history, with 15 cards being shown (10 yellow, 1~yellow-red, 2 red), and of those, 12 (8, 1, 1) were shown to Bayern players, which is also a~record in Bundesliga history.
\item Most championships won: 22
\item Most \fntit{cups} won: 15
\item Most \fntit{league cups} won: 6
\item Most doubles won: 8
\item Only club to win the double (\fntit{Bundesliga} and \fntit{cup}) twice in a~row (\fntit{2005--06} and \fntit{2006--07})
\item Only club to win a~championship in both men's and women's football 
\item Fastest goal in \fntit{Champions League} history: After 10 seconds by \fntit{Roy Makaay} on 7 March, 2007, against \fntit{Real Madrid}
\item Last club to win the Champions League/European Cup three times in a~row: 1974--76
\item Highest aggregate win in the UEFA Champions League knockout stage: 12--1 on 24 February, 2009, (5--0) and 11 March, 2009, (7--1) against \fntit{Sporting CP}
\konseznam
\vspace*{2mm}

\cast{Limited liability companies}
...
We can finally state that the outsourcing of significant branches of a~football undertaking into the form of an incorporated firm should be deemed a~considerable step forward in comparison with the deficient regulations of the operations of associations, regarding the economic professionality of football clubs, partially from the side of commercial law and partially from the side of shareholding law. Through the introduction of the organizational and legal structures necessary for football clubs to be considered professional, there are further positive effects generated for football companies: for example, the football undertaking has to reevaluate its assets due to the transformation, which usually has a~positive effect on the proportion of equity. This is still complemented by the fact that, in the event of incorporation, equity will increase through the accumulation of profits based on the compulsory regulations of the application of profits. Incorporation allows external investors to get involved in football undertakings, which may be implemented through investment into the respective business quotas of an LLC or a~share company or a~limited partnership. Here we must stress above all the obligation of publicity and information, which makes the incorporated firms transparent for potential investors of debt capital, and allows for reliable credit ratings and risk assessments. Furthermore, it is also advantageous that incorporated football firms operate similarly to incorporated firms functioning in other fields, from the point of view of the protection of creditors. Finally, a~large palette of alternative financing is available for incorporated firms which are not available for the original legal form and organizational structure of associations. Nevertheless, it should be underlined that, in the event of the use of the form of the incorporated football firm, it is about the transformation and change of the organizational unit of execution and not the total abandonment of the form of association. The form of association will continue to be the main form for football undertakings and a~fundamental solution for the procurement of capital. Due to the reasons above, in this respect professional football is partially exempt.\\[-2mm]

\podnadpis{Changed business model}
As a~result of the above changes, the business model of professional football has been fundamentally transformed.

\popist{Table 2: Comparison of the two models of football}
\small\zactab{|lcc|}\hline
\tabht{4mm}\bf Source of financing 		&	government revenues 	&	business revenues\\[2mm]
\bf Role of budget constraints	&	soft budget constraints	&	hard budget constraints\\[2mm]
\bf Feature of the owner 	&	no real owner 			&	real owner(s)\\[2mm]
\bf Operational 			&	Non-profit: 			&	\\
\bf framework			&	form of social club 		&	corporate form of company\\[2mm]
\bf Role of football 		&	legitimacy of the political system, &	service as a~subfield of the \\
					&	improving morale		&	entertainment industry\\[1mm]\hline
\kontab
\zdrojt{Source: András, 2004}

In the case of developed football countries and market economies, the business model has clearly prevailed in professional football. While in the developing countries, in spite of all the required structural changes, a~mixed system has been formed that still bears the elements of the state model.\\[-2mm]

\podnadpis{Organizational requirements for professional football entities\\in Switzerland}
...
\fntit{Swiss mandatory minimum organizational requirements for the teams of the Super League:}
...
\podnadpis{Teams of the OTP Bank League by legal forms of business\\and organizational forms}
At first sight, it can be claimed that there is nothing wrong with clubs participating in the OTP Bank League in terms of their restructuring into capital companies, as in Hungary the formal conversion of first-league clubs into capital companies has actually been implemented (Figure 5). In Switzerland, this restructuring move has been executed on the basis of the Association's mandatory requirement. In contrast, as has been pointed out above, the German first league still has a~number of clubs operating in the form of associations. Restructuring into capital companies has also been implemented in the Greek first league on a~mandatory basis.\\[-2mm]


\popist{Figure 5: Teams of OTP Bank League by legal forms of business and organization}
\tabcolsep35pt\small\zactab{|cc|}\hline
		\mc{2}{|c|}{\bf OTP Bank League}\\
\bf Football Club 		&	\bf Legal Form\\\hline
Gyõri ETO 			&	limited liability company\\
VIDEOTON 			&	limited liability company\\
Budapesti Honvéd 		&	limited liability company\\
MTK Budapest 		&	share company\\
Ferencvárosi TC 		&	share company\\
DVSC-TEVA 			&	share company\\
KTE-Phoenix 			&	limited liability company\\
Újpest FC 			&	limited liability company\\
DVTK 				&	limited liability company\\
Kaposvári Rákóczi 		&	limited liability company\\
PMFC Matias 			&	limited liability company\\
MVM-Paks 			&	limited liability company\\
Lombard Pápa Termál FC&	limited liability company\\
FGSZ Siófok 			&	limited liability company\\\hline
\kontab

\clearpage\newpage

\obr{bacs-fig05.jpg}{.5\textwidth}
\zdrojt{Source: Own research}\\
...
\podnadpis{Establishment of controlling organizational units\\at football enterprises}
...
\popist{Table 3: Application of controlling at German football clubs}
\tabcolsep18pt\small\zactab{|@{\hskip6pt}lc|}\hline
\bf Time of application of controlling &	\bf Distribution (\%)\\\hline
1--5 years 		&	58,5\\
5--10 years 		&	13,7\\
more than 10 years 	&	17,1\\
no answer 		&	10,3\\\hline
\kontab
\zdrojt{Source: Controlling im Profifußball, Roßbach, Th:2011, p. 43}\\
...
\popist{Table 4: Applied controlling devices and methods in Leagues 1--3. of Germany}
\tabcolsep20pt\small\zactab{|@{\hskip6pt}lc|}\hline
\bf Controlling devices and methods 			&	\bf Rate of application (\%)\\\hline
Benchmarking 	&	27.27\\
Comparison of planned and factual figures 	&	12.12\\
Balanced Scorecard 	&	\09.09\\
Obtainment of liquidity 	&	\06.06\\
Rolling forecasts 	&	\03.03\\
Scenario procedures &	\03.03\\
Profit and loss analysis 	&	\03.03\\
Detailed budgeting 	&	\03.03\\
Target cost analysis 	&	\03.03\\
Quarterly and monthly reports 	&	\03.03\\
Addison controlling tool 	&	\03.03\\
Own analyses &	\03.03\\
Deviation analyses 	&	\03.03\\
ABC analysis &	\03.03\\
Business plan &	\03.03\\
Others &	\03.03\\\hline
\kontab
\zdrojt{Source: Controlling im Profifußball, Roßbach, Th:2011, p.  44}\\
...
\popist{Table 5: The subject-matter of controlling in Leagues 1--2 of Germany}
\tabcolsep48pt\small\zactab{|@{\hskip6pt}lc|}\hline
\bf Subject of controlling 	&	\bf Intensity (\%)\\\hline
merchandizing &79.3\\
payments&89.7\\
operations &89.7\\
stadium use &79.3\\
media rights &82.8\\
sponsorship&96.6\\
player transfers &69.0\\
marketing&89.7\\\hline
\kontab
\zdrojt{Source: Controlling im Profifußball, Roßbach, Th:2011, p. 46}\\
...
Controlling has an increasingly important role in the operation of foreign football clubs, though its potential still has not been exploited optimally in major football nations. The processes will be accelerated by UEFA's new licensing regulations posing strict requirements and attributing an even more significant role to financial stability (financial fair play). Football is becoming increasingly professional and business-oriented, a~process which requires the application of modern management systems. The application of controlling is spreading, which improves the effectiveness of the business areas. This relatively new, gradually strengthening aspect, i.e. the economic side of football, seems to be extremely important for the clubs and the federations alike via the issuance of licenses. Additional stakeholders include football-related market vendors, agents, owners, as well as shareholding companies, creditors and even auditors. Abroad, in the major football nations, the current focal point of debate is the organizational forms of controlling systems. Experts deem it to be expedient to operate independent controlling departments organized in the light of the individual controlling tasks at the football clubs.\\[4mm]

\cast{References}
Allen, F. (2011). \fntit{Liquidity and crises}. Oxford: Oxford University Press.

András, K. (2004). \fntit{A~hivatalos labdarúgás piacai}. 53.sz Mûhelytanulmány. Budapesti Közgazdaságtudományi és Államigazgatási Egyetem, 2004.

Bács, Z., Szima G. (2012). \fntit{Értékek a~klubépítésben (és ami még mögötte van)}. Nemzetközi Turizmus és Sportmanagement Konferencia, Debrecen, 1--12.

Bács, Z., Szilágyi S. (2012). \fntit{A~DVSC BL szereplésének gazdasági és államháztartási vonatkozásai}.  Debreceni Egyetem, 1--6.

Borbély, A. (2012). Országos Sporttudományi Kongresszus. \fntit{Magyar Sporttudományi Szemle}, 12(2), 6--12.

Borbély, A. (2008). \fntit{Sportpolitika és sportgazdaság változásai Magyarországon és az Észak-alföldi Régióban, különös tekintettel a~küzdõsportokra} (habilitációs anyag).

Bott, S. (2007). \fntit{Internationalisierungsstrategien von nationalen Fußballigen}. 1. Auflage, Books on Demand GmbH, Norderstedt.

Dworak, A. (2010). \fntit{Finanzierung für Fußballunternehmen}. Berlin: Erich Schmidt Verlag.

Haas, O. (2006). \fntit{Controlling der Fußballsunternehmen}. Auflage 2. Berlin: Erich Schmidt Verlag.

Keller, Ch. (2006). \fntit{Corporate Finance im Profifussball}. Stuttgart: Ibidem Verlag.

Kotlán, I., Machová, Z., Janíèková, L. (2011). Taxation Influence On The Economic Growth. \fntit{Politická ekonomie}, 59(5), 638--658.

Lehmkuhl, D., Siegrist, O. (2009). \fntit{Swiss Football}. Retrieved from: http://www.ipw.uni\-sg.ch/org/ipw/web.nsf/SysWebRessources/Presentation+Lehmkuhl+Swiss+Football/\$FI-\\LE/SwissFootball.pdf.

Nagy, I.\;Z. (2011). The Fight against Income Evasion in Hungary. \fntit{Acta Polytechnica Hungarica, Journal of Applied Sciences}, 8(2), 103--116.

Nagy, I.\;Z. (2012a). Modern Forms of Business in Professional Football. \fntit{DANUBE: Law and Economics Review}, 3(2), 1--17.

Nagy, I.\;Z. (2012b). Die Rolle der Rechtsformen in der Führung des professionelen Fußballs. In proccedings of the \fntit{10th International Conference on Management, Enterprise and Benchmarking (MEB)}, Budapest, 2012, 193--209.

Nagy, I.\;Z. (2013). A~sikeres vállalkozás pénzgazdálkodása és pénzügyi tervezése. In \fntit{Vállalkozásfejlesztés a~XXI. században III.: tanulmánykötet}, Budapest: Óbudai Egyetem, 2013, 7--34.

\clearpage\newpage

Nagy I.\;Z., Való, V. (2013). The Lawful Execution of Employer Rights Is an Important Subsystem of Corporate Governance (A Labour Case Study). \fntit{DANUBE: Law and Economics Review}, 4(3), 201--217.

Roßbach, Th. (2011). \fntit{Controlling im Profifußball}. BiTS Business and Information Technology School GmbH. (Diplomarbeit) Iserlohn, Németország.
