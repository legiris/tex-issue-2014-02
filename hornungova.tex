\newpage\nuluj
\pagestyle{hornungova}

\logo

\nadpis{Development of Concepts and Models\\of Performance Evaluation from\\the 19\numend{th} Century to the Present}

\autor{Jana Hornungová\pozn{Brno University of Technology, Faculty of Business and Management, Kolejní 2906, 612 00 Brno, Czech Republic. E-mail: hornungova@fbm.vutbr.cz.}}
\linka{3ex}
...
\podnadpis{Methodology of literature review}
...
\popist{Figure\;1: Developments in performance assessment}
\obr{hornungova-fig01a.jpg}{.95\textwidth}
\zdroj{Source: Yadav, et al. (2013)}
...
\popist{Table\;1: Top 10 Management Tools}
\tabcolsep8pt\small\zactab{|@{\hskip6pt}lcc|}\hline
Rank&	2010	&	2012\\\hline
\01.	&	Benchmarking&Strategic Planning\\
\02.	&	Strategic Planning&CRM\\
\03.	&	Mission and Vision Statements&Employee Engagement Surveys\\
\04.	&	CRM&Benchmarking\\
\05.	&	Outsourcing&Balanced Scorecard\\
\06.	&	Balanced Scorecard&Core Competencies\\
\07.	&	Change Management Programs&Outsourcing\\
\08.	&	Core Competencies&Change Management\\
\09.	&	Strategic Alliances&Supply Chain Management\\
10.	&	Customer Segmentation&Mission and Vision Statements\\\hline
\kontab
\zdrojt{Source: Bain \& Company (2012)}
...
\zacseznam
\item Models which emphasize self-assessment -- e.g. the EFQM model. This model helps the company find areas in which it can continue to improve (self-assessment within the company), but also allows comparison with competitors (benchmarking). Some authors believe that there is currently much evidence of the successful application of EFQM or other similar models, fulfilling the principles of TQM (Total Quality Management), providing significant economic and social effects for the organization (Mariniè, 2008).
\item Models designed to support the management and improvement of business processes -- such as the performance pyramid or BSC.
\konseznam
...
\item EFQM;
\item ISO 9001:2000;
\item Performance Prism;
\item Six Sigma;
\item Tableau de Bord.
\konseznam
\clearpage\newpage

\cast{Tableau de Bord}
Tableau de Bord is mainly used when evaluating a~company's management. This concept is not only focused on financial indicators, but also addresses the issue of objectives, since vision and mission are translated into a~set of objectives, of which the key success factors are identified and subsequently converted into a~series of quantitative key performance indicators. The principle of this model is to focus on daily business operations and not pay too much attention to strategic issues (Epstein, Manzoni, 1997; Watts, McNair-Connolly, 2012).\\[1mm]

\cast{EFQM}
This model is considered one of the most sophisticated and complex tools for the permanent and systematic improvement of business performance. Great emphasis is placed on its results, including financial ones. The model is structured into nine basic criteria, five of which are tools (techniques) that the firm should implement to maximize results and the remaining four results that determine what the firms have achieved (Watts, McNair-Connolly, 2012; Nenadál, 2004). The main principle is the achieving of excellent results in several ways that are acceptable to corporate management and support its strategy. This model comes from Nenadál (2002) and is based on the principles of Total Quality Management (TQM), which incorporates the following elements: customer focus, continuous improvement, participatory, social consideration.\\[1mm]

\cast{Balanced Scorecard}
...
\zacseznam
\item The continuous improvement of processes; 
\item All activities of the company are composed of processes; 
\item Senior management support; 
\item The determination of priorities, the expansion of the competence of employees, support for the involvement and teamwork of employees; 
\item Continuous assessment of the performance of the process; 
\item The effort to approach statistical indicators, including for those persons who do not have a~very positive relationship with statistics; 
\item It is important to identify the subject of the measurement and the method of measurement; 
\item Work teams within the Six Sigma area are usually smaller groups of people interested in a~particular problem, with the support of its leadership (Töpfer, 2008).
\konseznam
...
\podnadpis{Materials, Methods and Results}
The basis of the empirical research was a~questionnaire prepared as part of the doctoral thesis of the author. For the purposes of the author´s research, businesses were selected which met the following two conditions:
\zacseznam
\item Registered economic companies from section J (CZ-NACE) -- Information and Communication Activities in the Czech Republic;
\item Enterprises with $> 250$ employees.
\konseznam
A basic sample was made of 56 companies who received the questionnaire. In total, 32 out of the 56 companies answered (effectiveness was almost 57.14\%). In terms of identification, it can be significantly statistically evaluated which types of legal form predominated: joint-stock companies (43.8\%) and limited liability companies (56.3\%).
...
{\bf\fntit{Statistical hypothesis: ``The legal form of the company does not affect the choice of how to evaluate the performance of the company."}}

\clearpage\newpage

It has been suggested that the chosen legal form of the business has no effect on the system performance of enterprises. To verify this hypothesis, answers to the following questions were used from the questionnaire: ``The legal form of your company." and ``What business performance evaluation system is used in your company?". For the basic test of mutual dependency, the chi-square test of independence was used, null hypothesis $\mathrm{H}_0: \pi_{ij} = \pi_{ij,0}$, which states that random variables are independent against the alternative hypothesis $\mathrm{H}_1$.
\zacseznam
\item $\mathrm{H}_0$: There is no relationship between the legal form of a~business and its enterprise performance evaluation system. 
\item $\mathrm{H}_1$: There is a~relationship between the legal form of a~business and its enterprise performance evaluation system.
\konseznam
...
\popist{Table 2: Calculation of $\chi2$ test of independence for Statistical Hypothesis}
\tabcolsep12pt\small\zactab{|ccc|}\hline
			&	Test criterion 	&	The minimum level of significance\\\hline
Chi-square 	&	4.107&0.534\\
Likelihood ratio&	5.241&0.387\\\hline
\kontab
\zdrojt{Source: Own research}

The resulting value of the minimum level of significance was tested at a~5\% significance level $(\alpha = 0.05)$. If the resulting value is less than or equal to $\alpha = 0.05$, $\mathrm{H}_0$ is rejected. Based on the calculation, it was found that the value of the Pearson chi-square statistics was 0.534. This result is greater than the chosen significance level $(0.534> 0.05)$. In this case, therefore, $\mathrm{H}_0$ is not rejected at the 5\% significance level, while $\mathrm{H}_1$ is rejected. $\mathrm{H}_0$ thus remains, as there was a~failure to refute the hypothesis because it has not been demonstrated that there is a~relationship between the choice of the legal form of business and the chosen system of evaluating the performance of the company.\\[-3mm]

$\Rightarrow$\hskip2mm Statistical hypothesis confirmed.\\
...
\cast{1. Classical and dominant PMM frameworks}
This theme includes those frameworks that have been very popular in literature as well as predominantly used by practitioners. Their contributions to the knowledge base are related to the incorporation of non-financial performance measures, quality, self-assessment and the inclusion of most of the stakeholders. These can be listed as follows:
\zacseznam
\item Balanced Scorecard;
\item Performance Pyramid;
\item EFQM -- excellence model; 
\item Performance Prism.
\konseznam
\vspace*{2mm}

\cast{2. Holistic and integrated PMM frameworks}
As discussed, to fulfill the need for a~holistic and integrated framework for company performance, researchers have highlighted the following developments, which primarily discuss aligning performance with the future, bringing individual performance in line with enterprise performance, and integrating operational, functional and strategic aspects of enterprise performance:
\zacseznam
\item Consistent PMS;
\item Integrated dynamic performance measurement system;
\item Dynamic performance measurement system;
\item Integrated performance measurement framework;
\item Dynamic multi-dimensional performance framework; 
\item Holistic performance management framework.
\konseznam

\clearpage\newpage

\cast{3. Frameworks updating BSC approach}
...
\zacseznam
\item Kanji's Business Scorecard;
\item Holistic Scorecard;
\item Total Performance Scorecard;
\item System dynamics based BSC; 
\item Proactive BSC.
\konseznam
\vspace*{2mm}

\cast{4. Context-specific PMM frameworks}
This category includes frameworks discussing the specific contexts of performance, such as economic value, social values, quantitative factors, performance value chain, etc. These PMM frameworks can be further clustered on the basis of underlying driving factors, as process-based frameworks (input-process-output-outcome framework, the performance planning value chain); financial performance drivers (shareholder value, economic value added); criticism of traditional control mechanism (beyond budgeting). Context-specific frameworks are:
\zacseznam
\item Measures for time-based competition;
\item Economic value added;
\item Input-process-output-outcome framework;
\item Shareholder value;
\item Quantitative models for performance measurement systems;
\item The action-profit linkage model;
\item Beyond budgeting; 
\item The performance planning value chain.
\konseznam
\vspace*{2mm}

\cast{5. Recently developed PMM frameworks}
...
\zacseznam
\item Flexible Strategy Game-Card; 
\item Sustainability performance measurement system.
\konseznam
...
This paper gives a~comprehensive view of existing performance management frameworks. The shift from financial measures to integrated measures, operational perspectives to strategic perspectives and consideration of a~set of stakeholders to all stakeholders have been the major visible changes.
...
Researchers in the field of performance measurement and management need to look beyond the scorecard and utilize these avenues of research to develop holistic, integrated, dynamic and effective PMSs that can help an enterprise to compete and succeed in turbulent and competitive business environments.\\
...
\cast{References}
Bain \& Company (2012). \fntit{Top 10 tools through the years}. Retrieved on April 19, 2013, from http://www.bain.com/management\_tools/BainTopTenTools/default.asp. 

Bititci, U.\;S. (1994). Measuring your way to profit. \fntit{Management Decision}, 32(6), 16--24.  

Elkington, J. (1997). \fntit{Cannibals with Forks: The Triple Bottom Line of 21st Century Business}. Oxford: Capstone. 

Epstein, M.\;J., Manzoni, J. (1997). The Balanced Scorecard and the Tableau de Bord: translating strategy into action. \fntit{Management Accounting}, 79(2), 28--36. 

Franceschini, F., Galetto, M., Maisano, D. (2007). \fntit{Management by Measurement. Designing Key Indicators and Performance Measurement Systems}. Berlin: Springer-Verlag Berlin Heidelberg.

\clearpage\newpage
George, M.\;L. (2010). \fntit{Lean Six Sigma kapesní pøíruèka}. Brno: SC\&C Partner. 

Hronová, S., Fischer, J., Hindls, R., Sixta, J. (2009). \fntit{Národní úèetnictví: nástroj popisu globální ekonomiky}. Praha: C.\;H. Beck

Kaplan, R.\;S., Norton, D.\;P. (2002). \fntit{Balanced Scorecard: strategický systém mìøení výkonnosti podniku}. Praha: Management Press.

Katic, D., Majstorovic, V., Colak, I. (2011). Performance Measurement Review. \fntit{Annals of DAAAM \& Proceedings}, 515--516. 

Mariniè, P. (2008). \fntit{Plánování a~tvorba hodnoty firmy}. Praha: Grada. 

Neèadová, M. (2012). Je HDP vhodným ukazatelem ekonomické výkonnosti a~sociálního pokroku v~podmínkách globalizace? \fntit{Acta oeconomica pragensia}, 20(5), 3--23.

Neely, A., Adams, C., Crowe, P. (2001). The Performance Prism in Practice. \fntit{Measuring Business Excellence}, 5(2), 6--12. 

Nenadál, J. (2002). \fntit{Moderní systémy øízení jakosti: Quality management}. Praha: Management Press.

Nenadál, J. (2004). \fntit{Mìøení v~systémech managementu jakosti}. Praha: Management Press.

Osberg, L., Sharpe, A. (2002). An Index of Economic Well-being for Selected OECD Countries. \fntit{Review of Income and Wealth}, 48(3), 291--316.

Paladino, B. (2007). \fntit{Five keys principles of corporate performance}. New Jersey: John Wiley \& Sons.

Quinn, J.\;B., Thomas, L.\;D. and Penny, C.\;P. (1990). Beyond products: service-based strategy. \fntit{Harvard Business Review}, March/April, 58--68.

Rigby, D. (2010). \fntit{Top 10 Management Tools}. Retrieved on December 19, 2010 from http://bain.com/publications/business-insights/management-tools-and-trends-2011.aspx\#. 

Töpfer, A. (2008). \fntit{Six Sigma: koncepce a~pøíklady pro øízení bez chyb}. Brno: Computer Press.

Vouldis, A., Kokkinaki, A. (2011). A~critical review of business performance models and frameworks and their application to sales organization. In \fntit{European Conference on Intellectual Capital}, 475--485. 

Watts, T., McNair-Connolly, C.\;J. (2012). New performance measurement and management control systems. \fntit{Journal of Applied Accounting Research}, 13(3), 226--241. 

Yadav, N., Sagar, S., Sagar, M. (2013). Performance measurement and management framework. Research trends of the last two decades. \fntit{Business Process Management}, 19(6), 947--970. 
